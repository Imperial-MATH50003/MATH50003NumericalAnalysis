...
Note that
\[
\ensuremath{\sum}_{k,j=0}^\ensuremath{\infty} |\hat{a}_k| |\hat{f}_j| =  \ensuremath{\sum}_{k=0}^\ensuremath{\infty} |\hat{f}_k| \ensuremath{\sum}_{j=0}^\ensuremath{\infty} |\hat{a}_j| = \|\ensuremath{\bm{\a}}\ensuremath{\hat}\|_1 \| \ensuremath{\bm{\f}}\ensuremath{\hat}\|_1
\]
...
\[
(a \ensuremath{\star} f)(\ensuremath{\theta}) = \ensuremath{\sum}_{k=0}^\ensuremath{\infty}  \hat{f}_k \ensuremath{\int}_0^{2\ensuremath{\pi}} a(\ensuremath{\theta}-\ensuremath{\varphi}) \E^{\I k \ensuremath{\varphi}} \D \ensuremath{\varphi} =  \ensuremath{\sum}_{j=0}^\ensuremath{\infty} \hat{a}_j \E^{\I j \ensuremath{\theta}}   \ensuremath{\sum}_{k=0}^\ensuremath{\infty} \hat{f}_k \underbrace{\ensuremath{\int}_0^{2\ensuremath{\pi}} \E^{-I j \ensuremath{\varphi}} \E^{\I k \ensuremath{\varphi}} \D \ensuremath{\varphi}}_{=\ensuremath{\delta}_{kj}}  = \ensuremath{\sum}_{k=0}^\ensuremath{\infty} \hat{f}_k \hat{a}_k \E^{\I k \ensuremath{\theta}}.
\]
Note that this has absolutely summable Fourier coefficients  since:
\[
\ensuremath{\sum}_{k=0}^\ensuremath{\infty} |\hat{f}_k \hat{a}_k| \ensuremath{\leq} \ensuremath{\sum}_{k=0}^\ensuremath{\infty} |\hat{f}_k| \ensuremath{\sum}_{j=0}^\ensuremath{\infty} |\hat{a}_j| = \|\ensuremath{\bm{\a}}\ensuremath{\hat}\|_1 \| \ensuremath{\bm{\f}}\ensuremath{\hat}\|_1.
\]
We can similarly write
\meeq{
(a \ensuremath{\star}_n f)(\ensuremath{\theta})  = \ensuremath{\sum}_{j=0}^{n-1} \ensuremath{\sum}_{k=0}^\ensuremath{\infty} \hat{a}_k E^{\I k (\ensuremath{\theta}-\ensuremath{\theta}_j)} f(\ensuremath{\theta}_j)
=  \ensuremath{\sum}_{k=0}^\ensuremath{\infty} E^{\I k \ensuremath{\theta}} \hat{a}_k \underbrace{\ensuremath{\sum}_{j=0}^{n-1}  E^{-\I k \ensuremath{\theta}_j} f(\ensuremath{\theta}_j)}_{\hat{f}_k^n}.
}
That is, its Fourier coefficients are given by, for $c := a \ensuremath{\star}_n f$,
\[
\hat{c}_k = \hat{a}_k \hat{f}_k^n = \hat{a}_k \ensuremath{\sum}_{p=0}^\ensuremath{\infty} \hat{f}_{\mod(k,n)+pn}
\]
We thus deduce
\begin{align*}
...
= \ensuremath{\sum}_{k=0}^{n-1} \br[|\hat{a}_k| (|\hat{f}_{k+n}| + \hat{f}_{k+2n}| + \ensuremath{\ldots}) +
 ...
 & \ensuremath{\leq}
 \| \ensuremath{\bm{\a}}\ensuremath{\hat} \|_1 \ensuremath{\sum}_{k=0}^{n-1}  \ensuremath{\sum}_{p=1}^\ensuremath{\infty} |\hat{f}_{k+pn}| + \|\ensuremath{\bm{\f}}\ensuremath{\hat}\|_1 \ensuremath{\sum}_{k=0}^{n-1}  \ensuremath{\sum}_{p=1}^\ensuremath{\infty} |\hat{a}_{k+pn}| \ccr
 = \| \ensuremath{\bm{\a}}\ensuremath{\hat} \|_1 \ensuremath{\sum}_{j=n}^\ensuremath{\infty} |\hat{f}_j| + \|\ensuremath{\bm{\f}}\ensuremath{\hat}\|_1 \ensuremath{\sum}_{j=n}^\ensuremath{\infty} |\hat{a}_j|.
\end{align*}
...
\[
\ensuremath{\bm{\e}}_k S(\ensuremath{\bm{\a}} \ensuremath{\otimes} \ensuremath{\bm{\f}} ) = \ensuremath{\bm{\e}}_{\mod(k-1,n)} (\ensuremath{\bm{\a}} \ensuremath{\otimes} \ensuremath{\bm{\f}} ) = \ensuremath{\sum}_{j=0}^{n-1} a_j f_{\mod(j+k-1,n)} = \ensuremath{\bm{\a}} \ensuremath{\otimes} S \ensuremath{\bm{\f}}.
\]
...
U_3(x) = 2xU_2(x)-U_1(x) = 8x^3 - 4x \\
U_4(x) = 2xU_3(x) - U_2(x) = 16x^4-12x^2 + 1 \\
