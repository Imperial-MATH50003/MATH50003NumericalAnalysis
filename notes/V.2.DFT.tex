...
In the problem sheet we see how the DFT can be extended to a cosine expansion, in the form of the Discrete Cosine Transform (DCT). In the lab, we see how the FFT implements the DFT in a fast manner, and see how the approximate cosine expansion can be constructed numerically. 
