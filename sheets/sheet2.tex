...
\rule{\textwidth}{1pt}
\textbf{Problem 6} Suppose $f$ is twice-differentiable in a neighbourhood of $B$ of $r$ such that $f(r) = f'(r) = 0$, where $f''$ does in $B$. Show  that the error of the $k$-th Newton iteration $\ensuremath{\varepsilon}_k := x - x_k$ satisfies
\[
