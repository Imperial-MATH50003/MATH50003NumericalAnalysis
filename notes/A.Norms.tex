...
\]
The default norm is the 2-norm $\|\ensuremath{\bm{\x}}\| := \|\ensuremath{\bm{\x}}\|_2$. \end{definition}
...
\]
For  the induced $p$-norm we use the notation $\|A\|_p$ and the default norm is the 2-norm: $\|A \| := \|A \|_2$. \end{definition}
