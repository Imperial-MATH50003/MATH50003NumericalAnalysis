...
\]
(Actually this bound is achieved and we have equality: $\| V^{-1}\| = \sqrt{2/n}$.) Thus the blow up of error in a 2-norm sense actually decreases with $n$!  Though this doesn't take into account floating point round-off error.
