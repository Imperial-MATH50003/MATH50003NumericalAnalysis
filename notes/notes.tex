...
% \input{IV.3.DifferentialEquations}
  ...
  \begin{enumerate}
      ...
      \item IV.2 Discrete Fourier Transform: The Trapezium rule approximation can be recast as a unitary matrix, known as the Discrete Fourier Transform (DFT). This is used to prove interpolation properties.
            \item IV.3 Convolutions: Convolutions are naturally ways of representing operators that commute with translations, and underly Convolutional Neural Networks. We discuss how discrete convolutions can be diagonalised using the DFT.
 \end{enumerate}
